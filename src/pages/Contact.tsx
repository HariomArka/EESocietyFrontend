...
const contactInfo = [
  {
    ...
    title: 'Email',
    content: 'ees@iiest.ac.in',
    link: 'mailto:ees@iiest.ac.in',
  },
  {
  ...
  },
  {
    ...
    title: 'Location',
    content: 'EE Dept., IIEST Shibpur, Howrah',
    link: null,
  },
  {
  ...
  return (
    <main className="bg-black text-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20 grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-blue-600/20 hover:-translate-y-0.5">
              Send Message
            </button>
          </form>
        </div>
        ...
        <div>
          ...
          <div className="bg-white/[0.03] border border-white/8 rounded-2xl p-6 border-l-2 border-l-blue-600">
            ...
            <p className="text-gray-400 text-sm">IIEST Shibpur, Howrah</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        <h2 className="text-3xl font-extrabold mb-4">Other Ways to Connect</h2>
        <p className="text-gray-500 mb-8">Follow us on social media for updates on upcoming events and announcements.</p>
        <div className="flex justify-center gap-4 flex-wrap">
          {['LinkedIn', 'Instagram', 'Facebook'].map(s => (
            <a key={s} href={`https://${s.toLowerCase()}.com`} target="_blank" rel="noopener noreferrer"
              className="bg-white/[0.05] hover:bg-blue-600 border border-white/10 hover:border-blue-500 text-gray-300 hover:text-white font-semibold py-2.5 px-6 rounded-xl transition-all duration-300 hover:-translate-y-0.5">
              {s}
            </a>
          ))}
        </div>
